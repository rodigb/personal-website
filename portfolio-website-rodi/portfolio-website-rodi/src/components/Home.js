        ...
        {/* <h1 className="home-header">Home<span class="blinking-space">_</span></h1> */}
          ...
          <div className="social-btns">
            <ul className="social-ul">
              <li className="social1"><a href='https://github.com/rodigb?tab=repositories'><FaGithub/></a></li>
              <li className="social2"><a href='https://www.linkedin.com/in/rodi-gemici-5b792a182/'><FaLinkedin/></a></li>
            </ul>
          </div>
